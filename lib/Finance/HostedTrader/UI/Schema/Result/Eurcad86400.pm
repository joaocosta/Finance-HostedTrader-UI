package Finance::HostedTrader::UI::Schema::Result::Eurcad86400;
...
__PACKAGE__->table("EURCAD_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:dq0MnmD6uUgn9JUtoSLeSw
