package Finance::HostedTrader::UI::Schema::Result::Eurchf604800;
...
__PACKAGE__->table("EURCHF_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:kam9CajhOMZgH8VJeuT6pA
