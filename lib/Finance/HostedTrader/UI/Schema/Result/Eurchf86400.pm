package Finance::HostedTrader::UI::Schema::Result::Eurchf86400;
...
__PACKAGE__->table("EURCHF_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:uxVStSj4exF7ZwFfLDmgUA
