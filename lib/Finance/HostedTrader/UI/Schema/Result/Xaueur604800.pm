package Finance::HostedTrader::UI::Schema::Result::Xaueur604800;
...
__PACKAGE__->table("XAUEUR_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:GzbPcRtmkCYnsH7/QgRvBQ
