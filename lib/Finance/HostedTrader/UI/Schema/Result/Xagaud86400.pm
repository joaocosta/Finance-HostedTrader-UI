package Finance::HostedTrader::UI::Schema::Result::Xagaud86400;
...
__PACKAGE__->table("XAGAUD_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:aOE5sokiu2hs4P4ZSnnDGw
