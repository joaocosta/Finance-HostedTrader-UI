package Finance::HostedTrader::UI::Schema::Result::Nzdchf86400;
...
__PACKAGE__->table("NZDCHF_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:fQkaL1iu7hiTtNHClLaQrA
