package Finance::HostedTrader::UI::Schema::Result::Audchf86400;
...
__PACKAGE__->table("AUDCHF_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:scobmHOEP9WEqVnbki+ruA
