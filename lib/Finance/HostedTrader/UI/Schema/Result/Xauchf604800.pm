package Finance::HostedTrader::UI::Schema::Result::Xauchf604800;
...
__PACKAGE__->table("XAUCHF_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:UlVaosSgMio2FM4xSfHpbQ
