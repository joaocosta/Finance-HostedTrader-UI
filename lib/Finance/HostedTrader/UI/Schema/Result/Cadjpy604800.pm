package Finance::HostedTrader::UI::Schema::Result::Cadjpy604800;
...
__PACKAGE__->table("CADJPY_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:RM8QwD+CrboY9wwMNjgwmw
