package Finance::HostedTrader::UI::Schema::Result::Xauaud86400;
...
__PACKAGE__->table("XAUAUD_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:zGKYExwy97FAMrjQCRORqw
