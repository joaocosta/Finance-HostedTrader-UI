package Finance::HostedTrader::UI::Schema::Result::Eurnzd604800;
...
__PACKAGE__->table("EURNZD_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:u389Ehk9uMxGKmYGspwl2w
