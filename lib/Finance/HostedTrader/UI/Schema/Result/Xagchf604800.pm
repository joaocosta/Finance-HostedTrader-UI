package Finance::HostedTrader::UI::Schema::Result::Xagchf604800;
...
__PACKAGE__->table("XAGCHF_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Amr7QywRRT1RwaNbf3scVw
