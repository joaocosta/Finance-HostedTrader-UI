package Finance::HostedTrader::UI::Schema::Result::Nzdcad86400;
...
__PACKAGE__->table("NZDCAD_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+6BpHGoqHT58Q3S6ItbFEA
