package Finance::HostedTrader::UI::Schema::Result::Xagnzd604800;
...
__PACKAGE__->table("XAGNZD_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:nP+DlCxpgTUUVaq/IWkTqg
