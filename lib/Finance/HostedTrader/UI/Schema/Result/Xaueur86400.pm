package Finance::HostedTrader::UI::Schema::Result::Xaueur86400;
...
__PACKAGE__->table("XAUEUR_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Ow6ERQmFDPahk3+32tBCEw
