package Finance::HostedTrader::UI::Schema::Result::Nzdcad604800;
...
__PACKAGE__->table("NZDCAD_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:tYjzOTeccbcPJ5mGpa0ngA
