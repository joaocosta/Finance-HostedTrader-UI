package Finance::HostedTrader::UI::Schema::Result::Audnzd604800;
...
__PACKAGE__->table("AUDNZD_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Iy5eEdJuMZgLQYZaDWegGQ
