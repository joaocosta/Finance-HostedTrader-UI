package Finance::HostedTrader::UI::Schema::Result::Usdcad604800;
...
__PACKAGE__->table("USDCAD_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:FrWLbD7NqecEJvVzaef6eQ
