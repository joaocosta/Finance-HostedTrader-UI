package Finance::HostedTrader::UI::Schema::Result::Nzdchf604800;
...
__PACKAGE__->table("NZDCHF_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:vrMdRCIUhY71Rratw+JXtA
