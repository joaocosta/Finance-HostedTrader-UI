package Finance::HostedTrader::UI::Schema::Result::Xauxag86400;
...
__PACKAGE__->table("XAUXAG_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ZaeulhmVj5dIEkuzQUH8SQ
