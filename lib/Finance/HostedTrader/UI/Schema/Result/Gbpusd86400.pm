package Finance::HostedTrader::UI::Schema::Result::Gbpusd86400;
...
__PACKAGE__->table("GBPUSD_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Htyb0fWW4jAEcts3YFBGHg
