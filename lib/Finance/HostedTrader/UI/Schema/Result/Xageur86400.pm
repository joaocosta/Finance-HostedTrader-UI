package Finance::HostedTrader::UI::Schema::Result::Xageur86400;
...
__PACKAGE__->table("XAGEUR_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:GVPWGRCNc5rRNBOhcF9arg
