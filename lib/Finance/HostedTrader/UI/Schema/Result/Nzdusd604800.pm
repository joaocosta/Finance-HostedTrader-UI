package Finance::HostedTrader::UI::Schema::Result::Nzdusd604800;
...
__PACKAGE__->table("NZDUSD_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:eudClE5Lj1hweNRGp4id8w
