package Finance::HostedTrader::UI::Schema::Result::Xaucad604800;
...
__PACKAGE__->table("XAUCAD_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:175QyItwn4VSxcA6N9ID6w
