package Finance::HostedTrader::UI::Schema::Result::Usdjpy604800;
...
__PACKAGE__->table("USDJPY_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:DYAP2vwVZHIwnlXbmUk5dQ
