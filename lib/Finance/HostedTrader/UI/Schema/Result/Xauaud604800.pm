package Finance::HostedTrader::UI::Schema::Result::Xauaud604800;
...
__PACKAGE__->table("XAUAUD_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:UfquUdFi9BzfV4qSfYxQPQ
