package Finance::HostedTrader::UI::Schema::Result::Cadjpy86400;
...
__PACKAGE__->table("CADJPY_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:T//vhx+hocEX2ckKqTKfyA
