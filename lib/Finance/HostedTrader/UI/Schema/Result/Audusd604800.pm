package Finance::HostedTrader::UI::Schema::Result::Audusd604800;
...
__PACKAGE__->table("AUDUSD_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:HbtGNCsyamJcpjUhelQ/qw
