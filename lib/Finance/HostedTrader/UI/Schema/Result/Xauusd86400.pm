package Finance::HostedTrader::UI::Schema::Result::Xauusd86400;
...
__PACKAGE__->table("XAUUSD_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:7+CzOkz9LNtBvMgVGpr5BA
