package Finance::HostedTrader::UI::Schema::Result::Gbpjpy604800;
...
__PACKAGE__->table("GBPJPY_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:IJ1CIV3gd+N+2rgN+8KbmQ
