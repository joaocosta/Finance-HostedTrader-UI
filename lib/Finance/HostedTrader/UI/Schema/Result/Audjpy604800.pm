package Finance::HostedTrader::UI::Schema::Result::Audjpy604800;
...
__PACKAGE__->table("AUDJPY_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:PSdblpMuIgl5ExI6lEIGiw
