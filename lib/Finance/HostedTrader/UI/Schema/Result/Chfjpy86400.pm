package Finance::HostedTrader::UI::Schema::Result::Chfjpy86400;
...
__PACKAGE__->table("CHFJPY_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:DPYZanqUg8VzOAm/YGz7NQ
