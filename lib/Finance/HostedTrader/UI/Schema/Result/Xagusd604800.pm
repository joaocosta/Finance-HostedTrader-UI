package Finance::HostedTrader::UI::Schema::Result::Xagusd604800;
...
__PACKAGE__->table("XAGUSD_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:gDfkQwSZVWzgaGz4Ca0oGQ
