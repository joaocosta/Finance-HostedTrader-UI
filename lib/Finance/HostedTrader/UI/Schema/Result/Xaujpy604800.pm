package Finance::HostedTrader::UI::Schema::Result::Xaujpy604800;
...
__PACKAGE__->table("XAUJPY_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:PUkr7/QXzIrLe6Tk2WSkdw
