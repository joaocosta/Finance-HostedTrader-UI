package Finance::HostedTrader::UI::Schema::Result::Gbpcad86400;
...
__PACKAGE__->table("GBPCAD_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:l8r1Y6FJUHoftEzqL45Nsw
