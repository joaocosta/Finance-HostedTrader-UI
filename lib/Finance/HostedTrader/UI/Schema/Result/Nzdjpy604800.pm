package Finance::HostedTrader::UI::Schema::Result::Nzdjpy604800;
...
__PACKAGE__->table("NZDJPY_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:O+S4kYge68SM0/IlBY6pPg
