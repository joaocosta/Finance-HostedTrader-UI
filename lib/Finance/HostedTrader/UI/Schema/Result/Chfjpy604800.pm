package Finance::HostedTrader::UI::Schema::Result::Chfjpy604800;
...
__PACKAGE__->table("CHFJPY_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:sLAASOdCOxP4OIiWw5pgxQ
