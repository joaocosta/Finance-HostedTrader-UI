package Finance::HostedTrader::UI::Schema::Result::Xagcad86400;
...
__PACKAGE__->table("XAGCAD_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:giGPMGj+skbNqaPAAcNUaQ
