package Finance::HostedTrader::UI::Schema::Result::Xagusd86400;
...
__PACKAGE__->table("XAGUSD_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:sJ6gu5optgpapgrZE5Mmig
