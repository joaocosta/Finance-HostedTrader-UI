package Finance::HostedTrader::UI::Schema::Result::Audusd86400;
...
__PACKAGE__->table("AUDUSD_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:JZHRXXjbz5EQRLs1WDW7wA
