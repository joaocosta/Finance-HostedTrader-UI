package Finance::HostedTrader::UI::Schema::Result::Euraud604800;
...
__PACKAGE__->table("EURAUD_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:QDRruRqIQzZFWQxd3UTa6Q
