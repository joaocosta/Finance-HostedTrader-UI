package Finance::HostedTrader::UI::Schema::Result::Xaucad86400;
...
__PACKAGE__->table("XAUCAD_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+HYQAFv9LH3+KcfqY6UFBw
