package Finance::HostedTrader::UI::Schema::Result::Eurjpy604800;
...
__PACKAGE__->table("EURJPY_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:R0s8VwVk3naRmUIhEVTj3A
