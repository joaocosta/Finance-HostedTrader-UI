package Finance::HostedTrader::UI::Schema::Result::Audgbp86400;
...
__PACKAGE__->table("AUDGBP_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ocQmOMFFMzRbtCxEVS/nWg
