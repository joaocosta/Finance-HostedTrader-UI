package Finance::HostedTrader::UI::Schema::Result::Eurgbp604800;
...
__PACKAGE__->table("EURGBP_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:MjJk6hHazP8OwKuks/+/OQ
