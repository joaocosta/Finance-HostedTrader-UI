package Finance::HostedTrader::UI::Schema::Result::Gbpchf604800;
...
__PACKAGE__->table("GBPCHF_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:6KWyFkSbIaV7e3SP2x9qtQ
