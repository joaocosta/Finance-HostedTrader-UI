package Finance::HostedTrader::UI::Schema::Result::Gbpusd604800;
...
__PACKAGE__->table("GBPUSD_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:YSEi/2RBnGwe7m9SQrldiA
