package Finance::HostedTrader::UI::Schema::Result::Xaugbp604800;
...
__PACKAGE__->table("XAUGBP_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:pvcxLhudcKn+o/owr3/Bzg
