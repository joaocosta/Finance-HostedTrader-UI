package Finance::HostedTrader::UI::Schema::Result::Audgbp604800;
...
__PACKAGE__->table("AUDGBP_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:DYGtLq0sfyFzmJe1mdVi2w
