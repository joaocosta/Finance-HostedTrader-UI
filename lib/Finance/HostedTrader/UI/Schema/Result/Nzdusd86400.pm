package Finance::HostedTrader::UI::Schema::Result::Nzdusd86400;
...
__PACKAGE__->table("NZDUSD_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:kl+Mkj2CvKtTVwpnXvlNmQ
