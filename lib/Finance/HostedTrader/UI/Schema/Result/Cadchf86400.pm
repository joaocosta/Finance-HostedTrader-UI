package Finance::HostedTrader::UI::Schema::Result::Cadchf86400;
...
__PACKAGE__->table("CADCHF_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:komJlDdpV1ViRVOkZpmoJA
