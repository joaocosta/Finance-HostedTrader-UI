package Finance::HostedTrader::UI::Schema::Result::Xagcad604800;
...
__PACKAGE__->table("XAGCAD_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ZGOEknKmImj8H6j/i67a0Q
