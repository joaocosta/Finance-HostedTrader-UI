package Finance::HostedTrader::UI::Schema::Result::Audcad86400;
...
__PACKAGE__->table("AUDCAD_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:lk64B9qKOi1d/5Qtm47v8A
