package Finance::HostedTrader::UI::Schema::Result::Xagaud604800;
...
__PACKAGE__->table("XAGAUD_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:TWibfjJRve7oBRQxxARMAQ
