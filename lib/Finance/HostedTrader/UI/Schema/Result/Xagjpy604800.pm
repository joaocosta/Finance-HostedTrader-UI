package Finance::HostedTrader::UI::Schema::Result::Xagjpy604800;
...
__PACKAGE__->table("XAGJPY_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:HLAVQpzr38ytBbfLMSEetg
