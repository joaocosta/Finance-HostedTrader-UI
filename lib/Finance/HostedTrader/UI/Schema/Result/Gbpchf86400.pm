package Finance::HostedTrader::UI::Schema::Result::Gbpchf86400;
...
__PACKAGE__->table("GBPCHF_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:995JXEV4flJ/17kOdc9pwg
