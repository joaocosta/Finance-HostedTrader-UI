package Finance::HostedTrader::UI::Schema::Result::Eurjpy86400;
...
__PACKAGE__->table("EURJPY_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:uWJ05kGNpunsygp4z9fqKA
