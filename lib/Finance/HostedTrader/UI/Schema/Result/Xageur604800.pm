package Finance::HostedTrader::UI::Schema::Result::Xageur604800;
...
__PACKAGE__->table("XAGEUR_604800");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:JRym/fk6eQpYwglSyEojzA
