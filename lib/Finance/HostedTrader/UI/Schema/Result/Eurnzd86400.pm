package Finance::HostedTrader::UI::Schema::Result::Eurnzd86400;
...
__PACKAGE__->table("EURNZD_86400");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:KKNY/N5kXyaOsacvqJftnQ
